...
import { ResetPasswordPayload, resetPasswordSchema } from '@/schema/user';
          ...
          <FormProvider {...form}>
            ...
            >
              <RHFInput
                ...
                isRequired
                description={<span className='text-default-500'>Enter the code you received</span>}
              />
              ...
              <RHFInput
                ...
                isRequired
                type='password'
                description={<span className='text-default-500'>Enter the your new password</span>}
              />
